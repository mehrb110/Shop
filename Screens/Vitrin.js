...
const Vitrin = props => {
    ...
    const [dataList, setDataList] = useState([{ "index": 1, "EntityItemTitle": "روسری نخی روسری نخی پاییز روسری نخی پاییز روسری نخی پاییز پاییزه", "ItemName": "نم نم استور", "Price": 1.310980000000000e+009, "Img": "https:\/\/testfrooshgah1100.loca.lt\/UploadCenter\/UploadedFiles\/1_0.jpg" }
